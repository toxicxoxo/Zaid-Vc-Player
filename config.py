...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Shubhanshutya")
ALIVE_NAME = getenv("ALIVE_NAME", "Null")
BOT_USERNAME = getenv("BOT_USERNAME", "Kigo_omfobot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Kigo_Music1")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/AMANTYA1/kigoo")
